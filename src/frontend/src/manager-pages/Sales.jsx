                    ...
                    <div id="Navigation-Bar" class="section-navbar wf-section">
                        <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" class="navbar w-nav">
                            <div class="container-navbar w-container">
                                <img src="https://uploads-ssl.webflow.com/64260e1e41b7543817fb5e11/642610a28e436e4736dafb3d_tam-box-logo.png" loading="lazy" width="240" height="200" alt="" class="store-image"></img>
                                <a href="#" class="sales w-button">Sales</a>
                                <a href="#" class="entrees w-button">X Report</a>
                                <a href="#" class="drinks w-button">Z Report</a>
                                <a href="#" class="sweets w-button">Excess</a>
                                <a href="#" class="sides w-button">Restock</a>
                                <a href="#" class="currentorder w-button">Inventory</a>
                                <a href="#" class="currentorder w-button">Menu</a>
                                <a href="#" class="currentorder w-button">POS</a>
